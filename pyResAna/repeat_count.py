...
#count the No. of distinct values in each srcFileName. The results are stored in
#a csv file: dstFileName
def distinct_value(srcDirName, srcFileName, dstWriter):
	f = file(srcDirName+"/"+srcFileName,"r")
	data_list = []
	data_list = f.readlines()
	...
	dstWriter.writerow(distinct_vn)
